  ...
  return (
    <>
      <Sheet open={isOpen} onOpenChange={handleSheetOpenChange}>
        <SheetContent className="w-full sm:w-[400px] md:w-[540px] p-0 overflow-y-auto">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium flex items-center gap-1">
                            ...
                            <span className="truncate max-w-[150px] sm:max-w-none">{container.name}</span>
                          </div>
                          <div className="text-xs text-muted-foreground truncate max-w-[150px] sm:max-w-none">{container.image}</div>
                        </div>
                      </div>
