...
import { Fingerprint, Shield, Lock, Check, AlertTriangle, WifiOff, Zap, Clock } from 'lucide-react';
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Activate Kyber-based quantum-resistant encryption for system tunnels
                  </p>
                </div>
                <Switch 
                  id="post-quantum" 
